        ...
        <div className="border-t border-white/20 mt-8 pt-6">
          <div className="flex flex-col sm:flex-row justify-between items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 mt-4 sm:mt-0">
              <Link 
                to="/shipping-policy" 
                className="text-deep-brown-foreground/60 hover:text-white text-sm transition-colors text-center"
              >
                Shipping Policy
              </Link>
              <Link 
                to="/cancellation-refund-policy" 
                className="text-deep-brown-foreground/60 hover:text-white text-sm transition-colors text-center whitespace-nowrap"
              >
                Cancellation & Refund
              </Link>
              <Link 
